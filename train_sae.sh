...
# --learning_rate 1e-4 \
# --l1_coefficient 1e-3 \
# --notes "Training SAE pooled_features ${hidden_dim_multiplier}x features with 10000 epochs"
...
--learning_rate 1e-4 \
--l1_coefficient 1e-3 \
--notes "Training SAE pooled_all_features ${hidden_dim_multiplier}x features with 10000 epochs"
